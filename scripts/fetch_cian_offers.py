# -*- coding: utf-8 -*-
"""
Скачивает страницы объявлений Циан по ссылкам из data/apartments.json.
Результат обновляет data/apartments.json. При ошибках сохраните HTML вручную в data/offers/.
"""
import json
import os
import re
...
def main():
    ...
    for i, apt in enumerate(apartments):
        ...
        if not html:
            print("  Пропуск. Сохраните страницу вручную в data/offers/.")
            time.sleep(2)
            continue
    ...
    print(f"\nОбновлено квартир: {updated}. Запустите scripts/create_map_cian.py.")
